...
const ENCRYPTION_KEY: string =  `qSl^rHeIEOo51WckOvG4Uc$@0VHPqdT7`; // Must be 256 bits (32 characters)
const IV_LENGTH: number = 16; // For AES, this is always 16

export default class CryptoHelper {
    public encrypt(text: string, encryptionKey: string = ENCRYPTION_KEY): string {
    ...
    public decrypt(text: string, encryptionKey: string = ENCRYPTION_KEY): string {
